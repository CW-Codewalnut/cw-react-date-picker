  ...
  return (
    <>
      ...
      <Layout>
        ...
        />
        <Link href="/demo">
          <p className="mt-4 text-center text-xs px-2 py-2">Wanted to checkout the configurable fields?<span className="text-blue-500 font-semibold hover:underline">Click here</span></p>
        </Link>
          </div>
        </div>
